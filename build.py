...
def build():
    ...
    render("catalog.html.j2", "/stroymaterialy/",
           "Стройматериалы в Волгограде: электрика, кровля, металлопрокат, утеплители | РОСТ",
    ...
    for c in catalog["categories"]:
        ...
        render("catalog-cat.html.j2", url,
               f"{c['name']} в Волгограде: цена и наличие на день обращения | РОСТ",
    ...
    render("works.html.j2", "/raboty/",
           "Выполненные работы: ремонт квартир и строительство домов в Волгограде | РОСТ",
